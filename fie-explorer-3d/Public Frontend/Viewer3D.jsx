...
// HT-10: Gaussian Blur en zonas de privacidad (personas/vehículos)
import { blurModelTextures, AUTO_ZONES } from '../../utils/texturePrivacyBlur';
 ...
 *   privacyZones    – zonas de desenfoque (default: AUTO_ZONES.GROUND_LEVEL)
 *   enablePrivacyBlur – activar/desactivar el blur de privacidad (default: true)
 */
export default function Viewer3D({
  modelPath,
  hotspots = [],
  onHotspotClick,
  privacyZones = AUTO_ZONES.GROUND_LEVEL,
    ...
    if (modelPath) {
      ...
      loader.load(
        ...
        async (gltf) => {
          ...
          // ── HT-10: Gaussian Blur en zonas con personas/vehículos ──
          if (enablePrivacyBlur && privacyZones.length > 0) {
            blurModelTextures(model, privacyZones, { mapKeys: ['map'] })
              .then(() => console.log('[PrivacyBlur] ✅ Desenfoque aplicado a texturas exteriores.'))
              .catch((err) => console.warn('[PrivacyBlur] ⚠️', err));
          }
