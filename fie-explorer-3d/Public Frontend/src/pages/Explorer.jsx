...
export default function Explorer() {
  ...
  const modelPath = selectedBuilding
    ? `/models/${selectedBuilding.code?.toLowerCase()}_${viewMode}_lod0.glb`
    : null;
  ...
  return (
    <div style={{
            ...
            {hotspots.length === 0 && selectedBuilding && (
              <div style={{
                ...
                <p style={{ fontSize: '0.82rem' }}>
                  Sin hotspots registrados para este edificio aún.
                </p>
              </div>
            )}
            {!selectedBuilding && (
      ...
      <div style={{ flex: 1, position: 'relative', overflow: 'hidden' }}>
        ...
        {/* Visor 3D principal */}
        <Viewer3D
          modelPath={selectedBuilding ? modelPath : null}
          hotspots={hotspots}
        ...
        {hotspots.length > 0 && (
          <div style={{
            ...
            fontSize: '0.72rem', color: 'var(--color-text-2)',
            boxShadow: 'var(--shadow-sm)',
          }}>
            {[
...
function HotspotListItem({ hotspot: h, active, onClick }) {
  ...
  return (
    <button onClick={onClick} style={{
      ...
      border: '1px solid',
      borderColor: active ? 'var(--color-primary-100)' : 'transparent',
      borderRadius: 'var(--radius-md)',
      cursor: 'pointer',
